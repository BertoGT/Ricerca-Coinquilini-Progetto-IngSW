...
public class Registrazione extends DatiUtente {
    ...
    public Registrazione(String nome, String cognome, Sesso sesso, String eMail,
            String password, int giorno, int mese, int anno, String cellulare, 
            Nazionalita nazionalita, Occupazione occupazione, Facolta facolta, 
            boolean fumatore, boolean cuoco, boolean sportivo, String cittaDiRicerca) 
    ...
    public int scriviDb() throws FileNotFoundException{
        if(this.controlloDB())
            return bm.scriviFile(this.toStringDB());
        else 
            return 1;
    }
